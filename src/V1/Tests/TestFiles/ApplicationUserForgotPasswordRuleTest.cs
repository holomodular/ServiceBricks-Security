...
namespace ServiceBricks.Xunit.Integration
{
    ...
    public abstract class ApplicationUserForgotPasswordRuleTestBase : IDisposable
    {
        public ApplicationUserForgotPasswordRuleTestBase()
        {
        }
        ...
        public virtual async Task TestRule()
        {
            ...
            queryBuilder.IsEqual(nameof(AuditUserDto.AuditName), AuditType.FORGOT_PASSWORD_TEXT);
            queryBuilder.And();
