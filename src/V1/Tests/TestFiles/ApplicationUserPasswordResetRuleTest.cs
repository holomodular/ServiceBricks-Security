...
namespace ServiceBricks.Xunit.Integration
{
    ...
    public abstract partial class ApplicationUserPasswordResetRuleTestBase : ApplicationUserForgotPasswordRuleTestBase
    {
        ...
        public override async Task TestRule()
        {
            ...
            queryBuilder.IsEqual(nameof(AuditUserDto.AuditName), AuditType.PASSWORD_RESET_TEXT);
            queryBuilder.And();
