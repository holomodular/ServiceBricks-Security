...
namespace ServiceBricks.Xunit.Integration
{
    ...
    public abstract class UserRegisterAdminRuleTestBase : IDisposable
    {
        ...
        public async Task TestRule()
        {
            ...
            var qb = ServiceQueryRequestBuilder.New().IsEqual(nameof(RoleDto.Name), SecurityConstants.ROLE_ADMIN_NAME);
