...
namespace ServiceBricks.Security.AzureDataTables
{
    public sealed class AuditUserQueryRule : BusinessRule
    {
        ...
        public AuditUserQueryRule(ILoggerFactory loggerFactory)
        {
            _logger = loggerFactory.CreateLogger<AuditUserQueryRule>();
        ...
        public static void RegisterRule(IBusinessRuleRegistry registry)
        {
            registry.RegisterItem(
                typeof(DomainQueryBeforeEvent<AuditUser>),
                typeof(AuditUserQueryRule));
        }
